/*
     Given a 2D matrix, convert it into a doubly-linked list with four pointers
     (next, previous, up, down). Each node should be connected to its right, left, up and down neighbors.
