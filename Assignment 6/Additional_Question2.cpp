/*
    ...
    remove all the nodes from each list which contains elements whose parity (number of 1s in binary) is even.

Example CLL: 9 -> 11 -> 34 -> 6 -> 13 -> 21  Output: 11 -> 13 -> 21
Example DLL: 18 <=> 15 <=> 8 <=> 9 <=> 14  Output: 8 <=> 14
*/
